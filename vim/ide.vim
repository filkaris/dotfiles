...
" ALE
let g:ale_enabled=1
let g:ale_linters={'php':['php','phpcs','phpstan'], 'javascript':['eslint'], 'typescript':['eslint','tsserver'], 'bash':['shellcheck'], 'go':['golangci-lint'], 'terraform':['terraform', 'terraform_ls']}
let g:ale_fixers={'php':['phpcbf', 'php_cs_fixer'],'javascript':['prettier'],'typescript':['prettier'],'typescriptreact':['prettier'], 'go':['gofmt'], 'elixir':['mix_format'], 'terraform':['terraform']}
